export const helpMessages = {
  ...
  "eject": "Click to eject the current sample from this channel. The clips that you recorded and captured from the ejected sample will remain available. You can load in a new sample from the database or your computer and record more clips to download or sequence in the channel below.",
  "addRegion": "Add an adjustable region to the waveform. Each region is assigned to a number [1-8] and can be triggered for live playback. If the sample has been uploaded to the database, these regions can be saved and loaded by other users.",
